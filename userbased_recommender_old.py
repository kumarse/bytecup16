...
for i in range(n_validation_users):
    ...
    valdata.iloc[i, valdata.columns.get_loc('label')] = user_predictions_df.loc[uid_val,qid_val]


# In[17]:

test_invdata.to_csv('CF-finaltestresults.csv', separator=",")
